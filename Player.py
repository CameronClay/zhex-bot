...
class Player:
    AMOUNT = 50
    def __init__(self, id, region, zwins = 0, zloses = 0, zties = 0, zelo = 1500, twins = 0, tloses = 0, tties = 0, telo = 1500, lastPlayed = None, racePref = Race.ANY):
        self.id = id
        self.region = region
    ...
    def MatchResult(self, ea, race, res : MatchRes):
