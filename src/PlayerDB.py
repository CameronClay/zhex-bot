...
class PlayerDB:
    ...
    def IsRegistered(self, playerId: int, region : Region):
    ...
    def Find(self, playerId: int, region : Region):
    ...
    def UnRegister(self, playerId: int, region : Region):
        if region == Region.ALL:
    ...
    def UpdateStats(self, player: Player):
