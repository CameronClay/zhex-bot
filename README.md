...
# Deploying bot bot
Bot is currently setup to be deployed on heroku. Create a .env file with DISCORD_TOKEN and DISCORD_GUILD set. Commit the repository to heroku and turn the bot on.
